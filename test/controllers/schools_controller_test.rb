...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { address: @school.address, code: @school.code, name: @school.name } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { address: @school.address, code: @school.code, name: @school.name } }
