...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { name: @section.name, school_id: @section.school_id } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { name: @section.name, school_id: @section.school_id } }
